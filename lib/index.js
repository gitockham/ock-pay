...
module.exports = class OckPay extends Emittery {
    /**
     * Create a new OckPay instance.
     */
    constructor () {
      super()
    ...
    reset () {
      this.data = {
        ...
        seeds: {
          ock: {
            mainnet: 'https://raw.githubusercontent.com/gitockham/ock-peers/master/mainnet.json',
            devnet: 'https://raw.githubusercontent.com/gitockham/ock-peers/master/devnet.json',
            testnet: 'https://raw.githubusercontent.com/gitockham/ock-peers/master/testnet.json'
          }
        }
      }
    }
    ...
    async __get (url, params = {}) {
      return axios.get(url, {
        params,
        headers: {
          'Accept': 'application/vnd.ock.core-api.v2+json'
        }
      })
    }
